...
import type { InvitationData } from "@/app/actions/equipe.actions";
import { GroupIcon, ShootingStarIcon, DollarLineIcon, CheckCircleIcon, ChevronDownIcon, ChevronUpIcon } from "@/icons";
                  ...
                  <div>
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2" style={{ scrollbarWidth: "none" }}>
                      {inv.actualites.slice(0, 5).map((actu) => (
                        <div
                          key={actu._id}
                          className="relative h-28 w-44 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700"
                        >
                          {actu.image ? (
